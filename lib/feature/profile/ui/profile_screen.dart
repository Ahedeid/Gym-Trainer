...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        title: AppStrings.yourProfile.tr(),
      ),
          ...
          children: [
            ...
            MainContainer(
              ...
              child: Column(
                children: [
                  CardInProfileWidget(
                    title: AppStrings.memberShipPlan.tr(),
                    onTap: () {
                      sl<AppRouter>().goTo(
                  ...
                  CustomDivider(),
                  CardInProfileWidget(
                    title: AppStrings.unitsOfMeasure.tr(),
                    onTap: () {
                  ...
                  CustomDivider(),
                  CardInProfileWidget(
                    title: AppStrings.attendanceHistory.tr(),
                    onTap: () {
                      showModalBottomSheet(
                          useSafeArea: true,
                          shape: RoundedRectangleBorder(
            ...
            MainContainer(
              ...
              child: Column(
                children: [
                  CardInProfileWidget(
                    title: AppStrings.myPaymentMethods.tr(),
                    onTap: () {
                      sl<AppRouter>().goTo(
                        screenName: ScreenName.comingSoonScreen,
                        object: false,
                  ...
                  CustomDivider(),
                  CardInProfileWidget(
                    title: AppStrings.fAQsConditions.tr(),
                    onTap: () {
